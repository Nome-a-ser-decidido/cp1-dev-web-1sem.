...
console.log(variavelNulo); // Print da variável nulo
console.log(variavelUndefined); // Print da variavel undefined
console.log(variavel); // Print da variavel com valor
